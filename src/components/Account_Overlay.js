...
export default function Account_Overlay(){
    ...
    return(
        <div className="absolute top-20 md:top-30 lg:top-25 w-2/5 md:w-1/5 lg:w-2/15 right-1 md:right-20 z-20 rounded-lg bg-gray-800 w-1/2">
            <div className="grid grid-cols-1 text-gray-200 text-base md:text-lg text-center py-3 flex">
