        ...
        <Link href = {"/services/" + service.displayName.text} >
            <div onClick={handleServiceSelect} className = "card cardAdjust">
                <div className ="card-body">
                    ...
                    <h4 className = "card-title">{service.displayName.text}</h4>
                    <p className = "card-text fs-4">Rating: {service.rating ? service.rating : "N/A" } {service.rating && <img  width = "10%" height = "50%" src = "https://th.bing.com/th/id/R.3462ebc891558b2ec8bde920fc3e41c1?rik=E8O%2fhD3daKvtqQ&riu=http%3a%2f%2fpluspng.com%2fimg-png%2fyellow-stars-png-hd-hd-quality-wallpaper-collection-pattern-2000x2000-star-2000.png&ehk=c3jJXJdBQ08FuZM9zuSX6iQGLOq3E56vFYYk59%2fe39I%3d&risl=&pid=ImgRaw&r=0"/>} </p>
                    <p className = "card-text fs-4">Price Range: {service.priceRange ? "$" + service.priceRange.startPrice.units: "UNKNOWN"} {service.priceRange ? "-$" + service.priceRange.endPrice.units: "" }</p>
                </div>
            </div>
         </Link>
